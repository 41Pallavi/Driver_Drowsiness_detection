...
train_data = train_datagen.flow_from_directory(
    r'C:\Users\91993\Desktop\driver_drowsiness_detection\dataset2\train',
    target_size=(80, 80),
    batch_size=8,
...
test_data = test_datagen.flow_from_directory(
    r'C:\Users\91993\Desktop\driver_drowsiness_detection\dataset2\test',
    target_size=(80, 80),
    batch_size=8,
    class_mode='categorical'
)
...
checkpoint = ModelCheckpoint(r'C:\Users\91993\Desktop\driver_drowsiness_detection\models1',monitor='val_loss',save_best_only=True,verbose=3)
